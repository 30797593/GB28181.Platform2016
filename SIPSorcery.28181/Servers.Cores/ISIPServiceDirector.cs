...
namespace SIPSorcery.GB28181.Servers
{
    public interface ISIPServiceDirector
    {
        ...
        Task<Tuple<string, int, ProtocolType>> BackVideoPlaySpeedControlReq(string gbid, string sessionid, string scale, DateTime range, int[] mediaPort, string receiveIP);
    }
}
